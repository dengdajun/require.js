	...
	function Global( vars ) {
		...
		that.layout = function (){
			...
			that.selector.find( ":input[name=ruleId]" ).select( {
				remote: {
					url: "nucleus/bizconfig/sysrule/getSelectList",
					type: 'POST'
				}
			} );
			...
			cols[ cols.length ] = { title: "规则", name: "ruleName", width: "180px", lockWidth: true };
