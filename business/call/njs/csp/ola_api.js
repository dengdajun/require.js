...
var ola = {
	...
	transfer : function(dst) {
		return this.send({action:"api", cmd:"transfer", args:{extn:this._extn, dest:dst}});
	},
	...
	monitor : function(dst) {
		return this.send({action:"api", cmd:"monitor", args:{extn: this._extn, dest: dst}});
	},
	...
	intercept: function(dest) {
		return this.send({action:"api", cmd:"intercept", args:{extn: this._extn, dest: dest}});
	},
	...
	three_way : function(dst) {
		return this.send({action:"api", cmd:"monitor", args:{extn: this._extn, dest: dst, three_way:"true"}});
	},
