...
*/
   ...
   dhtmlXTreeObject.prototype.insertNewItem_content=function(parentId,itemId,itemText,itemActionHandler,image1,image2,image3,optionStr,children){
      var parentObject=this._globalIdStorageFind(parentId);
      if (!parentObject) return (-1);
      var nodez=this._attachChildNode_content(parentObject,itemId,itemText,itemActionHandler,image1,image2,image3,optionStr,children);
   ...
   dhtmlXTreeObject.prototype._attachChildNode_content=function(parentObject,itemId,itemText,itemActionHandler,image1,image2,image3,optionStr,childs,beforeNode,afterNode){
...
/**************************begin by libin**********************************/
   ...
   * 发送短信的单击节点事件
   */
   dhtmlXTreeObject.prototype.setUserData_sendContent=function(itemId,name,value){

      	document.getElementById(itemId.split("_")[0]).attachEvent("ondblclick", function(){ parent.document.sitechform.msg_content.value += value; });
   ...
   /*
   	*发送短信的预定义短信选择
   	*/
   dhtmlXTreeObject.prototype.setUserData_sendMsg=function(itemId,name,value){   		
      var sNode=this._globalIdStorageFind(itemId,0,true);
         if (!sNode) return;
         if(name=="hint")
			 sNode.htmlNode.childNodes[0].childNodes[0].title=value;
            ...
            sNode.userData["t_"+name]=value;
            sNode.htmlNode.childNodes[0].childNodes[0].attachEvent("onclick", function(){ document.sitechform.action = "../k501_msg_content.jsp?msg_mod_id="+itemId; document.sitechform.target="ifram_mainFrame"; document.sitechform.submit();});                     
   };
   
   /*
    *预定义短信分类树节点单击事件
    */
   dhtmlXTreeObject.prototype.setUserData_preconcertContent=function(itemId,name,value){   		
      var sNode=this._globalIdStorageFind(itemId,0,true);
         if (!sNode) return;
         if(name=="hint")
			 sNode.htmlNode.childNodes[0].childNodes[0].title=value;
            ...
            sNode.userData["t_"+name]=value;
            sNode.htmlNode.childNodes[0].childNodes[0].attachEvent("onclick", function(){ document.sitechform.action = "../K502/sort_content.jsp?msg_mod_id="+itemId; document.sitechform.target="mainFrame"; document.sitechform.submit();});                     
   };
...
/**************************begin by hanjc**********************************/
   ...
   /*
   	*发送短信的预定义短信选择
   	*/
   dhtmlXTreeObject.prototype.setUserData_sendMsg_1=function(itemId,name,value){   		
      var sNode=this._globalIdStorageFind(itemId,0,true);
         if (!sNode) return;
         if(name=="hint")
			 sNode.htmlNode.childNodes[0].childNodes[0].title=value;
            ...
            sNode.userData["t_"+name]=value;
            sNode.htmlNode.childNodes[0].childNodes[0].attachEvent("onclick", function(){ document.sitechform.action = "../K083_msg_content.jsp?msg_mod_id="+itemId; document.sitechform.target="ifram_mainFrame"; document.sitechform.submit();});                     
   };
   
   /*
    *预定义短信分类树节点单击事件
    */
   dhtmlXTreeObject.prototype.setUserData_preconcertContent_1=function(itemId,name,value){   		
      var sNode=this._globalIdStorageFind(itemId,0,true);
         if (!sNode) return;
         if(name=="hint")
			 sNode.htmlNode.childNodes[0].childNodes[0].title=value;
            ...
            sNode.userData["t_"+name]=value;
            sNode.htmlNode.childNodes[0].childNodes[0].attachEvent("onclick", function(){ document.sitechform.action = "sort_content.jsp?msg_mod_id="+itemId; document.sitechform.target="mainFrame"; document.sitechform.submit();});                     
   };
