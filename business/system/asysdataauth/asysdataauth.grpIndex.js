define(function () { 
	...
	function Global( vars ) {
		...
		//缓存码值
		code.cache( "Is_No,Group_Type" );//Auth_Staff_Group_Typ
		...
		that.layout = function() {
			...
			cols[ cols.length ] = { title: "组类型", name: "groupType", width: "180px", lockWidth: true,mouseover: true,renderer: function( val, item, rowIndex){
				return code.getText( "Group_Type", val );
			}};
