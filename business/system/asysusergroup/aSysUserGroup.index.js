define(function () { 
	...
	function Global( vars ) {
		...
		that.layout = function() {
			...
			cols[ cols.length ] = { title: "组类型", name: "groupType", width: "60px", lockWidth: true ,align:'center',
					renderer:function(val,item,rowIndex){return base.code.getText("Group_Type",val);}};
