define(function () { 
	...
	function Global( vars ) {
		...
		that.layout = function() {
			...
			config.cols = cols = [];
			cols[ cols.length ] = { title: "审批组编号", name: "groupNo", width: "250px", lockWidth: true };
			cols[ cols.length ] = { title: "审批组名称", name: "groupName", width: "250px", lockWidth: true };
		...
		handlers.userManager = function( items ) {
			...
			that.page.open( {
				title: "审批组管理 | 组员管理",
				url: "appro/usergroup/togroupuser",
				size: "modal-lg",
				params: { item: item },
				events: {
					hiden: function( closed, data ) {
